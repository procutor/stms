-- Insert GS GIKOMERO TSS School into Schools table
INSERT INTO schools (
  id,
  name,
  type,
...
-- Insert Time Slots for GS GIKOMERO TSS (Monday to Friday)
-- Morning periods
INSERT INTO time_slots (id, "schoolId", day, period, name, "startTime", "endTime", session, "isBreak", "breakType", "isActive", "createdAt", "updatedAt") VALUES
...
-- Insert GS GIKOMERO TSS School Admin into Users table
-- Password hash for 'sEkamana1' using bcrypt with salt rounds 12
INSERT INTO users (
  id,
  email,
  name,
